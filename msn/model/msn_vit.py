...
https://github.com/facebookresearch/msn/blob/4388dc1eadbe3042b85d3296d41b9b207656e043/src/deit.py
"""
...
class MSNVisionTransformer(BaseBackbone):
    """ Vision Transformer """
    ...
    def __init__(self,
                 ...
                 attn_drop_rate=0.,
                 drop_path_rate=0.,
                 norm_layer=partial(nn.LayerNorm, eps=1e-6),  # todo: change to dict
                 conv_stem=False,
    ...
    def train(self, mode=True):
        ...
        #         cnt+=p.numel()
        #     print(f"Freeze all {cnt} parameters.")
...
# TODO: Rewrite this using configs


def deit_tiny(patch_size=16, **kwargs):
    model = MSNVisionTransformer(
